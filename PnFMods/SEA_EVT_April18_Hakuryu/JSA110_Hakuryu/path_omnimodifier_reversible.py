...
def main(fileDir):
    ...
    for fileObj in fileList:
        if file_extension(fileObj) == '.mfm' or file_extension(fileObj) == '.model' or file_extension(fileObj) == '.visual':
            print(fileObj)
            f=open(fileObj,'r+')
            ...
            for line in all_the_lines:
                f.write(line.replace('SEA_EVT_April18_Hakuryu/JSA017_Hakuryu_1942','SEA_EVT_April18_Hakuryu/JSA110_Hakuryu'))   
            f.close()
